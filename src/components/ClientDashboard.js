...
const ClientDashboard = () => {
  ...
  const handleStateChange = (e) => {
    ...
    // Reset city-related ticket data when state changes
    setTicketData((prevTicketData) => ({
      ...prevTicketData,
      state: selectedState, // Update the state in ticket data
      city: "", // Reset the city in ticket data
    }));
  };
  ...
  const handleCityChange = (e) => {
    ...
    // Update ticket data with the selected city
    setTicketData((prevTicketData) => ({
      ...prevTicketData,
      city: selectedCity, // Update the city in ticket data
    }));
  };
